...
bar_color_blue <- c("#1F77B4FF","#C7C7C7FF")
...
ggsave(filename = paste(site,"_fig_2.tiff", sep=""), plot =figure, 
       path = results_dir,
       scale = 1, width = 180,
       height = 156, units = c("mm"),
       dpi = 300, bg = "white")
ggsave(filename = paste(site,"_fig_2.png", sep=""), plot =figure, 
       path = results_dir,
       scale = 1, width = 180,
       height = 156, units = c("mm"),
       dpi = 300, bg = "white")
...
write.table(data_all_methyl_a_samples_pv_wide_wa_underm_heatmap, file = paste(working_dir,"/",site,"_UnderM_intergenic.csv",sep=""),
            sep = "\t", row.names = F)
write.table(summary_inter_under_wide, file = paste(working_dir,"/",site,"_UnderM_intergenic_pv.csv",sep=""),
            sep = "\t", row.names = F)
